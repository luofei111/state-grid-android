package com.nun.lib_base.utils.date;
...
public class DateUtil {
    ...
    public static String getYearDayMouth(Date date) {
        return DateToString(date, DateStyle.YYYY_MM_DD);
    }
    public static String getDayMouth(Date date) {
    ...
    //判断是否超过24小时
    public static boolean isOver24Hour(Date start, Date end)  {
